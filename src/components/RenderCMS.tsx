...
import IframeReader from './sections/IframeReader'
import FAQ from './sections/Faq/FAQ'
import NavigationImagesButtons from './sections/NavigationImagesButtons/NavigationImagesButtons'
