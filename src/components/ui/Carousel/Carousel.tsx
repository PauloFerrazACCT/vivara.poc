...
import useSlideVisibility from 'src/hooks/useSlideVisibility'
import {
  RightArrowIcon,
  LeftArrowIcon,
} from 'src/components/ui/Carousel/Arrows'
import Bullets from 'src/components/ui/Carousel/Bullets'
...
function Carousel({
  ...
  const { handlers, slide, sliderState, sliderDispatch, runAutoplay } =
    useSlider({
      ...
      {showPaginationBullets && (
        <div data-carousel-bullets>
          <Bullets
            ...
            ariaControlsGenerator={(idx) => `${id}-item-${idx}`}
